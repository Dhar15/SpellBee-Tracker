chrome.storage.local.get(
  ["startingLetterCounts", "hexLetters", "centerLetter", "hintTableData"],
  (res) => {
    const counts = res.startingLetterCounts || {};
    const hexLetters = res.hexLetters?.map(l => l.toUpperCase()) || [];
    const centerLetter = res.centerLetter?.toUpperCase();
    const hintCounts = res.hintTableData || {};
